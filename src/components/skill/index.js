const Skill = () => {
    ...
    <section class="section-skill">
        <div class="section-skill_content">
            <h2 class="section-skill_content__heading"> Professional Skills </h2>
            <div class="section-skill_content__metrics">
                <div class="section-skill_content__metrics__item">
                    <div class="section-skill_content__metrics__item__title">
        ...
        <img src="./src/images/imgSkill.png" alt="">
        <!-- <div class="section-skill_bg"></div> -->
